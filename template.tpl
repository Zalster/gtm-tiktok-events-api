        ...
        "selectItems": [
          {
            ...
            "displayValue": "Complete Payment (Default)"
          },
          {
            "value": "PlaceAnOrder",
            "displayValue": "Place An Order (Other)"
          }
        ],
        "simpleValueType": true,
        "help": "\u003cb\u003e\u003cu\u003eGA4 Purchase Event\u003c/u\u003e\u003c/b\u003e\u003cbr\u003e Select which TikTok event to map with when the purchase event is triggered in the GA4 Client\u003cbr\u003e\n\u003cb\u003ePlace An Order\u003c/b\u003e\u003cbr\u003e\nWhen a visitor places an order. This is considered a type of purchase event. We suggest using this purchase event type if the visitor is paying for goods or items. \u003cbr\u003e\n\u003cb\u003eCompletePayment\u003c/b\u003e\u003cbr\u003eWhen a visitor makes a payment. This is considered a type of purchase event. We suggest using this purchase event type if the visitor is paying for a service. This should be used if the the payment is a basic purchase event.",
        "alwaysInSummary": true,
        "defaultValue": "CompletePayment"
      },
      {
        "type": "SELECT",
        "name": "contentType",
        "displayName": "Content Type (set manually)",
        "macrosInSelect": false,
        "selectItems": [
          {
            "value": "product",
        ...
        "simpleValueType": true,
        "help": "If your items array don\u0027t contain any content type you can set it manually here. You can also set this through the event param x-ttq-content-type",
        "alwaysInSummary": true
      }
    ]
  }
...
if (getType(ttp) === 'string') {
  context.user.ttp = ttp;
}
